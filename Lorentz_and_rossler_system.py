...
plt.plot(t_array[0],np.log(10**(-6)*np.exp(A*t_array[0])), label= "delta(t)",color = "black")
plt.legend()
plt.show()

#plt.semilogy(t2,sep_dist)

#plt.semilogy(t2,np.exp(line[1])* np.exp(line[0]*t2))
#plt.plot(t2,line[1]+line[0] * t2)
#plt.plot(t2,line2[1]+line2[0] * t2)
#plt.plot(t2,line3[1]+line3[0] * t2)
